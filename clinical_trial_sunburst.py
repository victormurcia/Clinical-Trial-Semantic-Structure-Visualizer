...
# Load the data
expanded_df = pd.read_parquet("https://github.com/victormurcia/Clinical-Trial-Semantic-Structure-Visualizer/blob/main/full_test_sunburst.parquet.gzip")
criteria_df = pd.read_parquet("https://github.com/victormurcia/Clinical-Trial-Semantic-Structure-Visualizer/blob/main/ct_criteria.parquet.gzip")
